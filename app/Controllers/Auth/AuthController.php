        ...
        public function postSingUp($request, $response){
            ...
            try{
                ...
                if($validation->failed()){
                    return $response->withJson(array('errors' => $_SESSION['errors']),401);
                }
                ...
                return $response->withJson(array('error' => $e->getMessage()),401);
...
//=========================================== fungsi penunjang =========================
        ...
        public function attempt ($email, $password) {
            ...
            if(password_verify($password, $user->password)){
                ...
                $api_token = $this->generateApiKey();
                UsersModel::where('email', $email)->update(['api_token' => $api_token]);
